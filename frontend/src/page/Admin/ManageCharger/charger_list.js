...
const ChargerList = ({ userInfo, handleLogout, children }) => {
    ...
    const navigateToEditCharger = (user) => {
        // Navigate to UpdateUser component and pass user data as props
        history.push('/UpdateCharger', { user });
    };
            ...
            <main role="main" className="col-md-9 ml-sm-auto mr-auto col-lg-10 px-md-4 bg-light  content-wrapper">
                ...
                <div className="container-fluid  ">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h3 className="card-title mt-5 ml-3"><b>Manage Charger</b></h3>
                        <button className="btn btn-primary mt-5" onClick={navigateToCreateCharger} >Add Device</button>
                    </div>
                                            ...
                                            <tr key={charger._id} className='text-center'>
                                                ...
                                                <td className="py-1">
                                                    ...
                                                    <div className="btn-group" role="group">
                                                        <button className="btn btn-warning me-2" onClick={() => navigateToEditCharger(charger)}>Edit</button>
                                                        <button className="btn btn-danger" onClick={() => handleDeleteCharger(charger._id)}>Delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))
